...
## Loading keyframes from local fileserver
Simply set up a web server with npm in your keyframes directory with [this package](https://www.npmjs.com/package/static-server) npm package
